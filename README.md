...
| MCP | `mcpEnabled`, `mcpServers`, allow/deny tools, `mcpMaxTools`, `mcpMaxSchemaTokens`, `mcpMaxResultChars`, `mcpMaxExternalCallsPerRun`, timeout, audit and artifact directory |
