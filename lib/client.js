  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { style: styles.serverCard, "aria-label": `${t("mcpServer")}: ${server.name || server.id}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.grid, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.field, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { id: `deepseekeyes-mcp-allow-${index}`, style: styles.textArea, value: linesOf(server.allowedTools), placeholder: t("mcpAllowedToolsPlaceholder"), disabled: serverDisabled, onChange: (event) => onChange({ ...server, allowedTools: listFromText(event.target.value) }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: styles.label, htmlFor: `deepseekeyes-mcp-deny-${index}`, children: t("mcpDenyTools") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { id: `deepseekeyes-mcp-deny-${index}`, style: styles.textArea, value: linesOf(server.denyTools), placeholder: t("mcpDenyToolsPlaceholder"), disabled: serverDisabled, onChange: (event) => onChange({ ...server, denyTools: listFromText(event.target.value) }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.metricGrid, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(McpMetric, { label: t("mcpLatency"), value: Number.isFinite(runtimeServer?.latencyMs) ? `${formatCount(runtimeServer.latencyMs)} ms` : "\u2014" }),
    ...
    runtimeServer?.lastError?.message ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: styles.statusError, children: [
      t("mcpLastError"),
      ": ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gap: 14, marginTop: 14 }, children: [
      ...
      !runtime.loading && runtime.value !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.metricGrid, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(McpMetric, { label: t("mcpSelectedCount"), value: formatCount(runtime.value.summary?.exposedTools) }),
