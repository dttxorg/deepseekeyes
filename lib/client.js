...
function normalizeSettingsDraft(value = {}) {
  return {
    ...
    desktopTimeoutMs: Number.isInteger(value.desktopTimeoutMs) ? value.desktopTimeoutMs : 15e3,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.tokenGrid, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          ...
          children: [
            ...
            TOKEN_PRESETS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: item.value, children: t(item.label) }, item.value))
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          ...
          step: "1",
          value: value === 0 ? "" : value,
          placeholder: value === 0 ? t("tokenUnlimitedInput") : void 0,
          disabled: disabled || value === 0,
          onChange: (event) => onChange(numberFrom(event))
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: styles.hint, children: t("tokenHint") })
  ] });
}
