...
var OPTIONAL_ROUTE_FIELDS = /* @__PURE__ */ new Set(["visionProvider", "visionModel"]);
...
function DeepSeekEyesSettingsCard({ scope, api, t }) {
  ...
  const providerGroup = (0, import_react.useMemo)(
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.body, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.grid, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.field, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("datalist", { id: "deepseekeyes-vision-models", children: (providerGroup?.models ?? []).map((model) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: model.id, children: model.name }, model.id)) })
        ] })
      ] }),
